...
CREATE TABLE IF NOT EXISTS QCOMMERCE.OPS.COMPLAINT_TRUTH (
  TICKET_ID       STRING,
...
TRUNCATE TABLE QCOMMERCE.OPS.COMPLAINT_TRUTH;

COPY INTO QCOMMERCE.OPS.COMPLAINT_TRUTH
     (TICKET_ID, SOURCE_ORDER_ID, STORE_ID, RAISED_AT, REASON_CODE)
FROM (
  SELECT t.$1,
         t.$2::NUMBER,
         t.$3::NUMBER,
